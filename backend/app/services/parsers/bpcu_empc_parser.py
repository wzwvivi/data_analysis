...
def _load_data() -> dict:
    p = _DATA_DIR / "bpcu_empc_data.json"
...
_BASE_COLUMNS = ["timestamp", "source_port", "can_id_hex", "msg_name"]


@ParserRegistry.register
class BPCUEMPCParser(BaseParser):
    parser_key = "bpcu_empc_v1"
    name = "BPCU/EMPC配电系统"
    display_name = "BPCU/EMPC 配电系统"
    parser_version = "V1"
