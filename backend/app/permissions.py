...
ROLE_PAGE_ACCESS = {
    ROLE_ADMIN: ["*"],
    ROLE_USER: [PAGE_UPLOAD, PAGE_TASKS, PAGE_TASK_DETAIL, PAGE_TASK_ANALYSIS],
    ROLE_DATA_MANAGER_TSN: [PAGE_UPLOAD, PAGE_TASKS, PAGE_TASK_DETAIL, PAGE_TASK_ANALYSIS],
    ROLE_DATA_MANAGER_FCC: [PAGE_UPLOAD, PAGE_TASKS, PAGE_TASK_DETAIL, PAGE_TASK_ANALYSIS],
    ROLE_DATA_MANAGER_GROUND: [PAGE_UPLOAD, PAGE_TASKS, PAGE_TASK_DETAIL, PAGE_TASK_ANALYSIS],
    ROLE_LEADER: [
        PAGE_TASKS,
        PAGE_TASK_DETAIL,
        PAGE_TASK_ANALYSIS,
