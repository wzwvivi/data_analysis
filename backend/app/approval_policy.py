...
CHAINS_BY_KIND: dict[str, List[str]] = {
    ...
    # RS485 / mavlink / discrete / wireless 复用相同的设备协议审批链
    DRAFT_KIND_DEVICE_RS485: DEVICE_APPROVAL_CHAIN,
    DRAFT_KIND_DEVICE_MAVLINK: DEVICE_APPROVAL_CHAIN,
    DRAFT_KIND_DEVICE_DISCRETE: DEVICE_APPROVAL_CHAIN,
    DRAFT_KIND_DEVICE_WIRELESS: DEVICE_APPROVAL_CHAIN,
}
